...
export const defaultTheme: Theme = {
  ...
  components: {
    function: {
      parameter: 'space-y-3 p-2 border border-gray-700 hover:border-gray-600 rounded-md transition-colors',
    },
    functionContainer: [
    ...
    struct: {
      container: 'rounded-lg bg-gray-800/50 border border-gray-700',
      field: 'border border-gray-700 hover:border-gray-600 rounded-md transition-colors',
    },
