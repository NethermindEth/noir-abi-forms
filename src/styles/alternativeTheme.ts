...
export const cyberpunkTheme = createTheme({
  ...
  components: {
    function: {
      parameter: 'space-y-3 p-2 border-2 border-cyan-900/50 rounded-none hover:border-cyan-700/50 transition-colors',
    },
    functionContainer: [
...
export const retroTheme = createTheme({
  ...
  components: {
    function: {
      parameter: 'space-y-3 p-2 border-2 border-amber-800 rounded-none hover:border-amber-700 transition-colors',
    },
    functionContainer: [
    ...
    struct: {
      container: 'rounded-none bg-amber-900/50 border-2 border-amber-800',
      field: 'border-2 border-amber-800 rounded-none hover:border-amber-700 transition-colors',
    },
